...
class HkGemPageHandler(object):
    ...
    def parse(self, task):
        ...
        if status == 'OK':
            ...
            outputJsonLoc = os.path.join(keyOutputPath, 'hk_gem_stock_list_cn.json')
            outputTxtLoc = os.path.join(keyOutputPath, 'hk_gem_stock_list_cn.txt')
